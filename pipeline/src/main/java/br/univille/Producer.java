...
//código para enviar eventos para o Kafka
//funciona parecedo com o servicebus
...
public interface Producer {
    public void publishEvent(Event event);// toda mensagem precisa ter uma chave, o que pode ser o ID do evento, timestamp, etc.}
